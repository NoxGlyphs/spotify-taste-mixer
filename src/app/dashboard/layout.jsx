...
export default function DashboardLayout({ children }) {
  return (
    <div className="flex w-screen h-screen overflow-x-hidden">
      <Sidebar/>
      <div className="relative grow flex flex-col overflow-y-auto overflow-x-hidden  bg-[url('/frutiger.png')]">
        <header className="sticky top-0 flex justify-between w-full pl-6 pr-2 pt-2 z-30">
